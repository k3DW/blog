...
While it is possible to map the string "17.13.3" to both "14.43.17.13" and the specific URL used here, this isn't something I've done. For now this composite Action remains without a lookup table. Instead, you need to visit the [Release History page](https://learn.microsoft.com/en-us/visualstudio/releases/2022/release-history) and find the link manually.
...
If you want to use this action, you can take a look at [k3DW/setup-msvc](https://github.com/k3DW/setup-msvc).
